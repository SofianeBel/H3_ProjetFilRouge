...
const StatCard = ({ title, value, change, icon }) => {
  // Déterminer la couleur de la variation en fonction de sa valeur
        ...
        <div className="flex items-center">
          ...
          <div className="ml-5 w-0 flex-1">
            ...
            <dd className="flex items-baseline">
              ...
              {change && (
                <div className={`ml-2 flex items-baseline text-sm font-semibold ${changeColorClass} px-2 py-0.5 rounded-full`}>
                  {isPositiveChange ? (
